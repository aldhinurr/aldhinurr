...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/kategor-ruangan-excel', [FloorController::class, 'KategoriRuanganExcel'])->name('ruangan.excel');
        Route::get('/kategori-unit-excel', [FloorController::class, 'KategoriUnitExcel'])->name('unit.excel');
