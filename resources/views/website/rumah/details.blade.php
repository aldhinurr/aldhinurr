    ...
    <div class="container">
      <div class="row justify-content-between">
        <div class="single-content-item pb-4">
          ...
          <span class="info__desc pt-1">Luas: {{ $data->large }} m<sup>2</sup>, Kapasitas: {{ number_format($data->capacity) }}
            Orang</span>
          </p>
        ...
        <div class="col-lg-12">
          <div class="hotel-card-wrap">
            <div class="hotel-card-carousel-2 carousel-action">
              @foreach ($other_rumah as $rumah)
                <div class="card-item">
                  <div class="card-img-top overflow-hidden" style="height: 250px; width: auto;">
                    <a href="{{ route('website.rumah.show', $rumah->id) }}" id="link-detail" class="d-block">
                      @if ($rumah->layanan_gambars->first())
                        <img src="{{ asset($rumah->layanan_gambars[0]['picture']) }}" alt="hotel-img" />
                      @else
                        <img src="https://source.unsplash.com/600x400?rumah" alt="hotel-img" />
                      @endif
                    </a>
                  </div>
                  <div class="card-body">
