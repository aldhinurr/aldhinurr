          ...
          <div class="col-lg-12">
            <div class="search-result-content">
              <div class="section-heading">
                <h2 class="sec__title text-dark">Cari Rumah Susun / Transit</h2>
              </div>
                  ...
                  <form action="#" class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 pr-0">
                      <div class="input-box">
                        ...
                        <label class="label-text">Rumah Susun / Transit</label>
                        <div class="form-group">
                          <input class="form-control" type="text" id="keyword" name="keyword"
                            placeholder="Nama Rumah Susun / Transit" />
                        </div>
                      </div>
                    </div><!-- end col-lg-3 -->
  ...
  <section class="card-area section--padding">
    <div class="container">
      <div class="row" id="data-wrapper">
        @include('website.rumah._data')
      </div><!-- end row -->
      <div class="row">
        <div class="col-lg-12">
          <div class="btn-box mt-3 text-center">
            <button type="button" class="theme-btn load-more-data"><i class="la la-refresh mr-1"></i>Lihat Rumah Susun / Transit
              Lainnya</button>
          </div><!-- end btn-box -->
        </div><!-- end col-lg-12 -->
      </div><!-- end row -->
...
@section('scripts')
  <script type="text/javascript">
    var ENDPOINT = "{{ route('website.rumah') }}";
    var page = 1;
