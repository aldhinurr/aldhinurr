          ...
          <div class="col-lg-12">
            <div class="search-result-content">
              <div class="section-heading">
                <h2 class="sec__title text-dark">Sewa Layanan</h2>
              </div>
...
<script type="text/javascript">
    var ENDPOINTS = {
        ruang: "{{ route('website.rooms_sewa') }}",
        rku: "{{ route('website.rku_sewa') }}",
        cars: "{{ route('website.cars_sewa') }}",
        lapangan: "{{ route('website.lapangan_sewa') }}",
        selasar: "{{ route('website.selasar_sewa') }}",
        peralatan: "{{ route('website.peralatan_sewa') }}"
    };
    var page = 1;
