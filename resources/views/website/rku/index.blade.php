          ...
          <div class="col-lg-12">
            <div class="search-result-content">
              <div class="section-heading">
                <h2 class="sec__title text-dark">Cari Ruang Kuliah Utama</h2>
              </div>
                  ...
                  <form action="#" class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 pr-0">
                      <div class="input-box">
                        ...
                        <label class="label-text">Ruang Kuliah Utama</label>
                        <div class="form-group">
                          <input class="form-control" type="text" id="keyword" name="keyword"
                            placeholder="Nama Ruang Kuliah Utama" />
                        </div>
                      </div>
                    </div><!-- end col-lg-3 -->
  ...
  <section class="card-area section--padding">
    <div class="container">
      <div class="row" id="data-wrapper">
        @include('website.rku._data')
      </div><!-- end row -->
      <div class="row">
        <div class="col-lg-12">
          <div class="btn-box mt-3 text-center">
            <button type="button" class="theme-btn load-more-data"><i class="la la-refresh mr-1"></i>Lihat Ruang Kuliah Utama
              Lainnya</button>
          </div><!-- end btn-box -->
        </div><!-- end col-lg-12 -->
      </div><!-- end row -->
...
@section('scripts')
  <script type="text/javascript">
    var ENDPOINT = "{{ route('website.rku') }}";
    var page = 1;
