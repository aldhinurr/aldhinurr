    ...
    <div class="col-lg-4 responsive-column">
      <div class="card-item">
        <div class="card-img-top overflow-hidden" style="height: 250px; width: auto;">
          <a href="{{ route('website.room.show', $room->id) }}" id="link-detail" class="d-block" target="_blank">
        ...
        <div class="card-body">
          ...
          <div class="card-price d-flex align-items-center justify-content-between">
            ...
            @else
              <a href="{{ route('website.room.show', $room->id) }}" id="link-detail" class="btn-text" target="_blank">
