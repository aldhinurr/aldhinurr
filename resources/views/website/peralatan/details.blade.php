...
@section('content')
  ...
  <!-- ================================
                                                                                                                                                                                                                                                      START peralatan DETAIL BREAD
                                                                                                                                                                                                                                                  ================================= -->
  <section class="room-detail-bread padding-top-10px">
    <div class="container">
      @if (count($peralatan_pictures) > 0)
        <div class="full-width-slider carousel-action">
          @foreach ($peralatan_pictures as $image)
        ...
        <div class="col-lg-12">
          <div class="hotel-card-wrap">
            <div class="hotel-card-carousel-2 carousel-action">
              @foreach ($other_peralatan as $peralatan)
                <div class="card-item">
                  <div class="card-img-top overflow-hidden" style="height: 250px; width: auto;">
                    <a href="{{ route('website.peralatan.show', $peralatan->id) }}" id="link-detail" class="d-block">
                      @if ($peralatan->layanan_gambars->first())
                        <img src="{{ asset($peralatan->layanan_gambars[0]['picture']) }}" alt="hotel-img" />
                      @else
                        <img src="https://source.unsplash.com/600x400?peralatan" alt="hotel-img" />
                      @endif
                    </a>
                  </div>
                  <div class="card-body">
