        ...
        <div class="col-lg-12">
          <div class="hotel-card-wrap">
            <div class="hotel-card-carousel-2 carousel-action">
              @foreach ($other_selasar as $selasar)
                <div class="card-item">
                  <div class="card-img-top overflow-hidden" style="height: 250px; width: auto;">
                    <a href="{{ route('website.selasar.show', $selasar->id) }}" id="link-detail" class="d-block">
                      ...
                      @else
                        <img src="https://source.unsplash.com/600x400?selasar" alt="hotel-img" />
                      @endif
                    </a>
                  </div>
                  <div class="card-body">
