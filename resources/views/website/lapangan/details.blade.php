    ...
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="single-content-item pb-4 pt-4 text-right">
          ...
          <a href="{{ route('website.lapangan') }}" class="theme-btn theme-btn-small"><i class="la la-arrow-left"></i>
            Kembali</a>
        </div><!-- end single-content-item -->
      </div>
        ...
        <div class="col-lg-12">
          <div class="hotel-card-wrap">
            <div class="hotel-card-carousel-2 carousel-action">
              @foreach ($other_lapangan as $lapangan)
                <div class="card-item">
                  <div class="card-img-top overflow-hidden" style="height: 250px; width: auto;">
                    <a href="{{ route('website.lapangan.show', $lapangan->id) }}" id="link-detail" class="d-block">
                      ...
                      @else
                        <img src="https://source.unsplash.com/600x400?lapangan" alt="hotel-img" />
                      @endif
                    </a>
                  </div>
                  <div class="card-body">
