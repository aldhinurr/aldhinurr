...
<div class="card {{ $class }}">
  ...
  <div class="card-header rotate cursor-pointer">
    ...
    <div class="d-flex my-4">
      ...
      <a href="{{ route('layanan.edit', $layanan->id) }}" class="btn btn-sm btn-primary align-self-center">
        {{ __('Ubah') }}</a>
    </div>
    <!--end::Action-->
  </div>
    ...
    <div class="card-body border-top p-9">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="row mb-6">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">{{ __('Kapasitas') }}</label>
            <!--end::Label-->

            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
              <span class="fw-bolder fs-6 text-dark">{{ $layanan->capacity }} Orang</span>
            </div>
            <!--end::Col-->
          </div>
          <!--end::Input group-->
...
<div class="card {{ $class }}">
  ...
  <div class="card-header rotate cursor-pointer border-0" role="button" data-bs-toggle="collapse"
    data-bs-target="#kt_layanan_layanan_gambars" aria-expanded="true" aria-controls="kt_layanan_layanan_gambars">
    <!--begin::Card title-->
    <div class="card-title m-0">
      <h3 class="fw-bolder m-0">{{ __('Gambar Layanan') }}</h3>
    </div>
    <!--end::Card title-->
  </div>
  <!--begin::Card header-->
          ...
          <div class="col-lg-3 p-3">
            ...
            <a class="d-block overlay" data-fslightbox="lightbox-basic" href="{{ asset($img['picture']) }}">
              ...
              <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-250px"
                style="background-image:url('{{ asset($img['picture']) }}')">
              </div>
              <!--end::Image-->
