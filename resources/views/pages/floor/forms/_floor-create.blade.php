...
<div class="card {{ $class }}">
  ...
  <div class="card-header rotate cursor-pointer border-0" role="button" data-bs-toggle="collapse"
    ...
    <div class="card-title m-0">
      <h3 class="fw-bolder m-0">{{ __('Tambah Data Lantai & Ruang') }}</h3>
      <!--begin::Separator-->
  ...
  <div id="kt_floor_create" class="show collapse">
    ...
    <form id="kt_floor_create_form" class="form" method="POST" action="{{ route('floor.store') }}">
      ...
      <div class="card-body border-top p-9">
        ...
        <div class="row mb-6">
          ...
          <div class="col-lg-8 fv-row">
            ...
            <input type="hidden" name="unit_itb" id="unit_itb" value="{{ auth()->user()->itb_unit }}">
          </div>
          <!--end::Col-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-6 fv-row">
                <select id="building_id" name="building_id" class="form-control form-control-lg">
                    <option value="" disabled selected>~~ Silahkan Pilih Gedung ~~</option>
        ...
        <input type="hidden" name="gedung" id="gedung" />
        <input type="hidden" name="kode_ruang" id="kode_ruang" />
      ...
      <input type="hidden" name="tgl_singkronisasi"/>
      <input type="hidden" name="flag_tambah" value="Y"/>
