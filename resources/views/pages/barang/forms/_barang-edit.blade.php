...
<div class="card {{ $class }}">
  ...
  <div class="card-header rotate cursor-pointer border-0" role="button" data-bs-toggle="collapse"
    ...
    <div class="card-title m-0">
      <h3 class="fw-bolder m-0">{{ __('Update Data Informasi Barang Tidak Digunakan') }}</h3>
    </div>
    <!--end::Card title-->
  </div>
  <!--begin::Card header-->
  ...
  <div id="kt_building_create" class="show collapse">
    <!--begin::Form-->
    <form id="kt_barang_create_form" class="form" method="POST"
      ...
      <div class="card-body border-top p-9">
        ...
        <div class="row mb-6">
          ...
          <!-- <div class="col-lg-8 fv-row">
            ...
            name="unit_itb" id="unit_itb" value="{{ old('name', $barang->unit_itb ?? '') }}">
          </div> -->
          <style>
          ...
          <div class="col-lg-7 fv-row">
           <div class="form-group">
            ...
            <option value="{{ old('name', $barang->unit_itb ?? '') }}">{{ $barang->unit_itb }}</option>
        ...
        <div class="row mb-6">
          ...
          <div class="col-lg-2 fv-row">
            ...
            value="{{ old('name', $barang->nomor_aset ?? '') }}" />
          </div>
          <!--end::Col-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-6">
          ...
          <div class="col-lg-4 fv-row">
            ...
            value="{{ old('name', $barang->nama_barang ?? '') }}" />
          </div>
          <!--end::Col-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-6">
          ...
          <!--begin::Col-->
          <div class="col-lg-4 fv-row">
            <textarea name="kondisi" class="form-control" placeholder="Jelaskan kondisi barang...">{{ old('name', $barang->kondisi ?? '') }}</textarea>
          </div>
          <!--end::Col-->
        </div>
        <!--end::Input group-->
