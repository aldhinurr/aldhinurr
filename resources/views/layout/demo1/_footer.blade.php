...
<div class="footer py-4 d-flex flex-lg-column {{ theme()->printHtmlClasses('footer', false) }}" id="kt_footer">
  ...
  <div
    ...
    <div class="text-dark order-2 order-md-1">
      <span class="text-muted fw-bold me-1">&copy; Copyright {{ date('Y') }}.</span>
      <a href="{{ route('website.index') }}" target="_blank" class="text-gray-800 text-hover-primary">Direktorat Sarana dan
        Prasarana</a>
    </div>
    <!--end::Copyright-->
