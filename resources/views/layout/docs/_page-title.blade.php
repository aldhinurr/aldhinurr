...
<!--begin::Page title-->
<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true"
  ...
  <h1 class="d-flex align-items-center text-dark my-1 fs-4">
    @if (
        !empty(theme()->hasOption('page', 'description')) &&
            theme()->getOption('layout', 'page-title/description') !== false)
      <!--begin::Separator-->
        ...
        @if ($item['active'] === true)
          <li class="breadcrumb-item text-dark">
            ...
            @if (theme()->getOption('page', 'exclusive') === true)
              <span class="badge badge-success fw-bold fs-9 px-2 ms-2 cursor-default ms-2" data-bs-toggle="tooltip"
                title="Developed in-house for Metronic">Exclusive</span>
            @endif
          </li>
        @else
